...
- The [settings plugin](src/main/kotlin/io/revanced/patches/gradle/SettingsPlugin.kt):
  Applied to the `settings.gradle.kts` file, configures the project repositories and subprojects
- The [patches plugin](src/main/kotlin/io/revanced/patches/gradle/PatchesPlugin.kt):
  Applied to the patches subproject by the settings plugin
- The [extension plugin](src/main/kotlin/io/revanced/patches/gradle/ExtensionPlugin.kt):
